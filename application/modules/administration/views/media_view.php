            ...
            <div class="col-lg-12">
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-users fa-fw"></i> GESTION DES MEDIAS</h3>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#list').DataTable( {
            ...
            "ajax": "<?=site_url('administration/media/read_medias')?>",
            "oLanguage": {
            ...
            "columns": [
                {"render": function ( data, type, row ) {
                    ...
                    return '<img src="<?php echo base_url()?>/uploads/medias/'+ row["media_image"]+'"  height="50" width="50"  ">'
                ...
                {"render": function ( data, type, row ) {
                    ...
                    if(row["media_type"]=='video') {
                        return '<a target="_blank" href="' + row["media_lien"] + '" >voir la video</a>'
                    }else{
                        return "";
                    }
                },},
                ...
                {"render": function ( data, type, row ) {
                    ...
                    return '<div class="text-center"  style="cursor:pointer"><a data-toggle="modal" data-target="#editUser" onclick="edited('+ row["media_id"]+')"><i class="fa fa-pencil " style="color: green"></i> </a>' +
                        '<a class=""  onclick="deleted('+ row["media_id"]+')" ><i class="fa fa-trash  " style="color: red"></i> </a>'+
                        '<a class=""  onclick="See('+ row["media_id"]+')" ><i class="fa fa-eye  " style="color: blue"></i> </a></div>'

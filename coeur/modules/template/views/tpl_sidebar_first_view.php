                    ...
                    <div id="sidebar-chat-tab" class="col s12 sidebar-messages right-sidebar-panel">
                        ...
                        <div class="chat-list">
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src="<?php echo base_url() ?>assets/images/profile-image-1.png" class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src="<?php echo base_url() ?>assets/images/profile-image-3.jpg" class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
             ...
             <aside id="chat-messages" class="side-nav white">
                ...
                <div class="messages-container">
                    <div class="message-wrapper them">
                        <div class="circle-wrapper"><img src="<?php echo base_url() ?>assets/images/profile-image-1.png" class="circle" alt=""></div>
                        <div class="text-wrapper">Lorem Ipsum</div>
                    </div>
                    <div class="message-wrapper me">
                        <div class="circle-wrapper"><img src="<?php echo base_url() ?>assets/images/profile-image-3.jpg" class="circle" alt=""></div>

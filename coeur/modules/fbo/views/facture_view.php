...
<!-- Mirrored from steelcoders.com/alpha/v1.2/invoice.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 02 Sep 2016 03:44:53 GMT -->
<head>
      ...
      <title>Forever Living product</title>
        ...
        <meta name="author" content="mickrone" />
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="invoice.html" class="active-page">Invoice</a></li>
                                    ...
                                    <div class="card-content  white-text">
                                        <div class="row">
                                            ...
                                            <div class="col s12 m6 l6 right-align">
                                                <h4>(Fcfa) <?php echo $montant_final; ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-transparent no-m">
                                <div class="card-content invoice-relative-content">
                                    <div class="row">
                                        ...
                                        <div class="col s12 m6 l6 right-align">
                                            <a href="<?php echo base_url() ?>fbo" class="btn-floating btn-large waves-effect waves-light light-green invoice-edit-btn"><i class="material-icons">edit</i></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m12 l12">
                                            <table class="table responsive-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>#451</td>
                                                        <td>Demande de credit</td>
                                                        <td><?php echo $motif; ?></td>
                                                        <td class="right-align">1</td>
                                                        <td class="right-align">(Fcfa) <?php echo $montant_final; ?></td>
                                                        <td class="right-align">(Fcfa) <?php echo $montant_final; ?></td>
                                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6 l8">
                                            <span class="heading-title">Merci !</span>
                                            <p>Votre confiance est notre fierte.</p>
                                            <img src="<?php echo base_url() ?>assets/images/ignature.png" class="invoice-signature m-t-md" alt="">
                                        </div>
                                        <div class="col s12 m6 l4 right-align">
                                            <div class="text-right">
                                                <h6 class="m-t-sm light-blue-text"><b>Subtotal</b></h6>
                                                <h5 class="">(Fcfa) <?php echo $montant_final; ?> </h5>
...
<!-- Mirrored from steelcoders.com/alpha/v1.2/invoice.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 02 Sep 2016 03:44:57 GMT -->
</html>